        ...
        <main className="max-w-4xl mx-auto">
          ...
          <section id="testimonials" className="p-6 my-12">
            ...
            <figure className="my-12 ">
                ...
                before:translate-y-2 after:content-['\201d'] after:font-serif after:absolute after:bottom-0  after:right-0 after:text-9xl after:text-white after:opacity-25 after:transform after:translate-x-2
                after:translate-y-2">
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptates ex rerum earum, alias deserunt veniam tempora sapiente dolor culpa, eaque aut eum non!
                </p>
