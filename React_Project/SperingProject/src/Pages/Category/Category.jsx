        ...
        <div className="flex flex-col  items-center w-full sm:w-[90%] ">
          ...
          <div className="w-full sm:w-[80%] flex flex-wrap gap-28 justify-center sm:justify-between items-center mt-10 mb-20">
            ...
            <div className="flex flex-col justify-center items-center ">
              ...
              <h3 className="mt-3 text-2xl font-semibold">Video Edting</h3>
            </div>
            <div className="flex flex-col justify-center items-center ">
              <img className="w-[50%]" src={categoryImage5} alt="" />
              <h3 className="mt-3 text-2xl font-semibold">Logo Design</h3>
            </div>
            <div className="flex flex-col justify-center items-center ">
              <img className="w-[50%]" src={categoryImage6} alt="" />
              <h3 className="mt-3 text-2xl font-semibold">Game Design</h3>
            </div>
          </div>
        </div>
      </section>
