...
const Footer = () => {
  return (
    ...
    <footer className='w-full h-[100vh] flex flex-col items-center border-[3px] border-red-700 bg-[#1a2e35]'>
      <section className='w-full h-[77vh]  flex flex-col justify-center gap-16 sm:max-w-[90%] xl:max-w-[90%] bg-red-200 mt-10'>
        ...
        <div className='grid grid-rows-4 text-center gap-3 sm:grid-cols-4 bg-blue-600 h-[30vh]'>
          <div className='bg-red-400'>
            <h2 className='text-2xl font-bold uppercase tracking-wider md:text-xl xl:text-2xl'>Useful Link</h2>
            <ul>
              <li className='text-lg xl:text-xl'>
                <Link to='/'>Home</Link>
              </li>
              <li className='text-lg xl:text-xl'>
          ...
          <div>
            <h2 className='text-2xl font-bold uppercase tracking-wider md:text-xl xl:text-2xl'>Office</h2>
            <p className='text-lg text-center sm:text-justify sm:text-md'>Readable content of a page when looking at its layoutreadable content of a page when looking at its layout</p>
          </div>
          <div>
          <h2 className='text-2xl font-bold uppercase tracking-wider md:text-xl xl:text-2xl'>Information</h2>
          <p className='text-lg text-center sm:text-justify sm:text-md'>Readable content of a page when looking at its layoutreadable content of a page when looking at its layout</p>
          </div>
          <div className='flex flex-col gap-y-4 sm:gap-2'>
          <h2 className='text-2xl font-bold uppercase tracking-wider md:text-xl xl:text-2xl'>Newsletter</h2>
          <div>
            <input className='w-[80%] p-4 sm:p-1 xl:p-2 xl:w-[95%] xl:placeholder:text-xl' type="text" placeholder='Email' />
          </div>
          <div className='mb-4'>
      ...
      <section className='w-full h-[15vh] text-center p-6 bg-white'>
