    ...
    <div className='w-full bg-slate-400 h-auto flex justify-between items-center'>
        <div>
            <div className='ml-10 flex justify-center items-center'>
                <img className='w-10 md:w-8' src={logoImage} alt="Logo-Image" />
                <h3 className='text-slate-100 text-sm md:text-xl font-bold'>Spering</h3>
        </div>
        </div>
        <div>
        ...
        <div className='mr-5'>
            {
                ...
                :
                <div><span className='text-xl text-slate-100 font-bold' onClick={handleChanges}>X</span></div>
