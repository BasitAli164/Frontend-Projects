    ...
    <>
     <section className="bg-black h-24 relative">
      <section className="absolute top-6 left-3">
        <Link to='/' className="text-white text-3xl font-bold">Healet</Link>
      </section>
      <section >
        <div className="fixed top-6 right-5 z-10">
          {toggle === false ? (
            <div className="w-10 h-10 bg-white rounded-full text-center">
              <span className="text-3xl cursor-default text-black" onClick={handleToggle}>
                &#9776;
              </span>
            </div>
          ) : (
            <div className="w-10 h-10 bg-black  rounded-full text-center" >
              <span className="text-3xl  cursor-default text-white font-bold " onClick={handleToggle}>
                &#10005;
              </span>
            </div>
          )}
