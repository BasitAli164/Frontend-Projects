  ...
  return (
    ...
    <section className=' w-full flex flex-col justify-start items-center  h-screen  gap-y-10 mb-20'>
      ...
      <div className='max-w-[800px] h-[350px] bg-[#160e0b] rounded-xl shadow-2xl flex flex-col justify-center items-center relative'>
        ...
        <div className="text-center  after:content-['\201C'] after:text-white after:text-8xl after:absolute after:bottom-[-50px] lg:after:bottom-[-30px]">
      ...
      <div className='flex justify-center items-center gap-10'>
          <button className='bg-[#fd9c6b] p-3 rounded-md w-14 border-none outline-none active:outline-none hover:bg-[#160e0b] duration-[0.6s]'>
